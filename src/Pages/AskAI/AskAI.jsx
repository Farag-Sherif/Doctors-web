...
const AskAI = () => {
    ...
    return (
        <div className="ask-AI flex min-h-screen bg-[#eef3ff] h-full">
            <div className="chat-area flex-1 bg-[#eef3ff] min-h-screen pb-10 text-white flex flex-col justify-between pt-10">
                {/* Header */}
                <div className="header px-5 md:px-10 py-5 flex justify-between items-center fixed top-0 left-0 right-0 bg-gradient-to-br from-blue-100 to-indigo-100 z-10 shadow-lg">
                ...
                <div className="messages overflow-y-auto flex-1 px-5 md:px-10 pt-15">
                    {messages.length === 0 ? (
                        <div className="text-center text-gray-500 mt-20">
                            ...
                            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
                                <div className="bg-gradient-to-br from-blue-100 to-indigo-100  p-4 rounded-xl text-left cursor-pointer" onClick={() => setInput('What are the symptoms of diabetes?')}>
                                    <p className="text-sm text-gray-400">example:</p>
                                    <p>What are the symptoms of diabetes?</p>
                                </div>
                                <div className="bg-gradient-to-br from-blue-100 to-indigo-100  p-4 rounded-xl text-left cursor-pointer" onClick={() => setInput('What are the symptoms of high blood pressure?')}>
                                    <p className="text-sm text-gray-400">example:</p>
                                    <p>What are the symptoms of high blood pressure?</p>
                                </div>
                                <div className="bg-gradient-to-br from-blue-100 to-indigo-100  p-4 rounded-xl text-left cursor-pointer" onClick={() => setInput('What are the causes of fever?')}>
                                    <p className="text-sm text-gray-400">example:</p>
                                    <p>What are the causes of fever?</p>
                                </div>
                                <div className="bg-gradient-to-br from-blue-100 to-indigo-100  p-4 rounded-xl text-left cursor-pointer" onClick={() => setInput('How can I improve my mental health?')}>
                                    <p className="text-sm text-gray-400">example:</p>
                        ...
                        messages.map((msg, index) => (
                            <div
                                ...
                                className={`message ${msg.type === 'user'
                                    ? 'user-message bg-gradient-to-br from-blue-100 to-indigo-100 text-black ml-auto'
                                    : 'ai-message bg-gradient-to-br from-blue-100 to-indigo-100 '
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="whitespace-pre-wrap flex-1 text-black">{msg.text}</p>
                                    {msg.type === 'user' && (
                    ...
                    {loading && (
                        <div className="message ai-message bg-gradient-to-br from-blue-100 to-indigo-100  p-5 rounded-2xl mb-5 w-fit max-w-full">
                ...
                <div className="input-area mt-5">
                    <div className="flex items-center gap-3 px-5 md:px-10">
                        <textarea
                            ...
                            className="flex-1 resize-none bg-white p-3 rounded-2xl outline-none text-black placeholder-gray-500 focus:ring-2 focus:ring-[#19A7CE] transition-all"
