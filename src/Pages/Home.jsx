        ...
        <div className="home-page">
            <section className="landing min-h-screen h-full main-bg relative overflow-hidden z-0 pt-20 pb-10 flex items-end justify-center px-5">
                <div className="container mx-auto h-full flex items-center justify-between gap-10 flex-col-reverse lg:flex-row">
                    <div className="left-side h-full flex flex-col justify-end items-center lg:items-start text-center lg:text-left gap-6 w-full lg:w-lg">
                        ...
                        <div className="patients-records mt-5">
                            <div className="images">
                                <img src="https://i.ibb.co/0j3y2vY/doctor-1.png" alt="Patient 1" className="-ml-6 border-4 border-white rounded-full w-12 h-12 object-cover inline-block" />
                                <img src="https://i.ibb.co/0j3y2vY/doctor-1.png" alt="Patient 2" className="-ml-6 border-4 border-white rounded-full w-12 h-12 object-cover inline-block" />
                                <img src="https://i.ibb.co/0j3y2vY/doctor-1.png" alt="Patient 3" className="-ml-6 border-4 border-white rounded-full w-12 h-12 object-cover inline-block" />
                                <img src="https://i.ibb.co/0j3y2vY/doctor-1.png" alt="Patient 4" className="-ml-6 border-4 border-white rounded-full w-12 h-12 object-cover inline-block" />
                                <img src="https://i.ibb.co/0j3y2vY/doctor-1.png" alt="Patient 5" className="-ml-6 border-4 border-white rounded-full w-12 h-12 object-cover inline-block" />
                    ...
                    <div className="right-side relative lg:absolute bottom-0 right-0 md:block w-full md:w-auto h-auto -z-10 ">
                        <div className="img">
                            <img src={landingImage} alt="" className=" lg:h-[calc(100vh-100px)] object-cover mix-blend-darken mx-auto" />
                        </div>
                        <div className="best-doctor">
                            <div className="content bg-white rounded-2xl shadow-lg py-3 px-5 flex items-center gap-4 w-fit absolute top-1/2 -left-15 transform ml-5">
                                ...
                                <div className="text">
                                    ...
                                    <h3 className="font-semibold text-sm text-gray-500">Best Doctor</h3>
                                </div>
                            </div>
                            <div className="content bg-white rounded-2xl shadow-lg py-3 px-5 md:flex items-center gap-4 hidden  w-fit absolute bottom-5 right-1/4 transform ml-5">
                                ...
                                <div className="text">
                                    ...
                                    <h3 className="font-semibold text-sm text-gray-500">Specialist Nurse</h3>
                                </div>
                                <div className="addtional-info ">
                                    <h3 className="font-bold text-sm text-end mb-1.5">good</h3>
                                    <h3 className="font-semibold text-sm border px-5 rounded-2xl">5k Patients</h3>
                                </div>
                            </div>
            ...
            <section className="additional-info py-20">
                <div className="container mx-auto flex flex-col items-center text-center px-5 md:flex-row md:items-center md:text-left md:justify-between gap-10">
                    <h2 className="text-4xl font-bold mb-5 w-full md:w-1/2 text-center">We provide a wide range of
                        medical services</h2>
                    <p className="text-lg text-gray-600 w-full md:w-1/2">We treat you like family, providing compassionate
                ...
                <div className="container mx-auto px-5">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="section-item bg-blue-50 p-10 rounded-xl text-center flex flex-col items-center gap-5">
                            ...
                            <p className="text-gray-500">We are committed to providing the highest quality care to our patients, ensuring their health and well-being.</p>
                        </div>
                        <div className="section-item bg-blue-50 p-10 rounded-xl text-center flex flex-col items-center gap-5">
                            <i className="fa-solid fa-user-doctor text-5xl text-blue-500"></i>
                            <h3 className="text-2xl font-bold">Expert Doctors</h3>
                            <p className="text-gray-500">Our team of experienced doctors is dedicated to providing compassionate and personalized care to our patients.</p></div>
                        <div className="section-item bg-blue-50 p-10 rounded-xl text-center flex flex-col items-center gap-5">
                            <i className="fa-solid fa-briefcase-medical text-5xl text-blue-500"></i>
                            <h3 className="text-2xl font-bold">Advanced Technology</h3>
                            <p className="text-gray-500">We utilize the latest medical technology and equipment to ensure accurate diagnoses and effective treatments for our patients.</p>
                        </div>
                    </div>
                </div>
            </section>
            <section className="preparing-your-future py-20">
                <div className="container mx-auto flex flex-col items-center text-center px-5 md:flex-row md:items-center md:text-left md:justify-between gap-10">
                    ...
                    <div className="text-content w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left gap-5  md:h-[500px] justify-around bg-blue-50 p-10 rounded-xl">
                        <h2 className="text-xl font-bold border px-5 py-3 rounded-2xl w-full md:w-2/3 text-center border-gray-400">Preparing your future</h2>
                        <h2 className="text-4xl font-bold w-full md:w-2/3">Achieving
                            Your Vision</h2>
                        <p className="text-lg text-gray-400">Planning for retirement is essential to
                            5:41
                            your long-term financial well-being, At
                            Finovote, our exporionced team
                            collaborates with you to identity your
                            retirement goals</p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-5">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="specialty-item bg-blue-50 p-10 rounded-xl flex flex-col items-center gap-5 justify-center hover:shadow-lg hover:scale-105 transition-transform duration-300  min-h-[200px]">
                            ...
                            <p className="text-gray-500 text-center  opacity-0 invisible  duration-300">Comprehensive eye exams and personalized care for all ages.</p>
                        </div>
                        <div className="specialty-item bg-blue-50 p-10 rounded-xl flex flex-col items-center gap-5 justify-center hover:shadow-lg hover:scale-105 transition-transform duration-300  min-h-[200px]">
                            <div className="icon-and-title flex flex-col items-center gap-3  duration-300  mt-10">
                            ...
                            <p className="text-gray-500 text-center  opacity-0 invisible  duration-300">Expert diagnosis and treatment for heart-related conditions.</p>
                        </div>
                        <div className="specialty-item bg-blue-50 p-10 rounded-xl flex flex-col items-center justify-center gap-5 hover:shadow-lg hover:scale-105 transition-transform duration-300 min-h-[200px]">
                            ...
                            <p className="text-gray-500 text-center opacity-0 collapse duration-300">Comprehensive care for neurological disorders and conditions.</p>
                        </div>
                    </div>
                    <div className="button">
                        <button className="mt-10 ml-auto mr-5 block underline duration-300 text-lg font-semibold text-blue-700 hover:text-red-600" style={{ border: "none" }}>Explore More <i className="fa-solid fa-arrow-right"></i></button>
                    </div>
                </div>
            </section>
            <section className="doctors py-20">
                <div className="container mx-auto px-5 overflow-x-hidden">
                    <div className="title">
                        <h2 className="text-5xl font-bold text-center mb-4">Highly Qualified Team</h2>
                        <p className='text-center text-gray-500 max-w-lg mx-auto'>Meet our highly qualified doctors and nurses, who are dedicated to providing exceptional care to our patients.</p>
                    </div>
                    ...
                    <Swiper
                        ...
                        <SwiperSlide
                            ...
                            <div className="doctor-item p-5 bg-blue-50 rounded-xl text-center flex flex-col items-center gap-5 overflow-hidden">
                                <img src={doctor_1} alt="Doctor 1" className="w-full object-cover" />
                                <div className="info flex lg:items-start items-center gap-3 bg-white p-5 rounded-xl shadow-lg -mt-10 w-full justify-between">
                                    ...
                                    <div className="contacts flex justify-center flex-row gap-0">
                                        <Link to="#" className="bg-green-50 mr-3 p-3 w-13 h-13 flex justify-center items-center rounded-full text-green-500 text-xl hover:bg-green-600 transition-all duration-300"><i className="fa-solid fa-phone"></i></Link>
                                        <Link to="#" className="bg-yellow-50 mr-3 p-3 w-13 h-13 flex justify-center items-center rounded-full text-yellow-500 text-xl hover:bg-yellow-600 transition-all duration-300"><i className="fa-solid fa-business-time"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide
                            className="slideContent  min-w-[250px]">
                            <div className="doctor-item p-5 bg-blue-50 rounded-xl text-center flex flex-col items-center gap-5 overflow-hidden">
                                <img src={doctor_1} alt="Doctor 1" className="w-full object-cover" />
                                <div className="info flex lg:items-start items-center gap-3 bg-white p-5 rounded-xl shadow-lg -mt-10 w-full justify-between">
                                    <div className="text">
                        ...
                        {/* <SwiperSlide
                                    className="slideContent  min-w-[200px]">
                            <div className="doctor-item p-5 bg-blue-50 rounded-xl  flex flex-col items-center gap-5 overflow-hidden h-full">
                            <Link to="#">See All Doctors <i className="fa-solid fa-arrow-right"></i></Link>
                            </div>
                                </SwiperSlide> */}
                    </Swiper>
                </div>
                        ...
                        <div className="overlay absolute bottom-5 right-0 bg-white flex items-center justify-between rounded-xl p-5">
                            <div className="experts mr-10  flex items-start gap-2">
                                ...
                                <div className="text">
                                    ...
                                    <p className="font-semibold text-md text-gray-400"> Expert Doctors</p>
                                </div>
                            </div>
                            <div className="patients flex items-start gap-2">
                                ...
                                <div className="text">
                                    ...
                                    <p className="font-semibold text-md text-gray-400">Operation Specialist</p>
                                </div>
                            </div>
                        </div>
                    </div>
